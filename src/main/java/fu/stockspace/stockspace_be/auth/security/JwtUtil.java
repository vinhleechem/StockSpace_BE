...
public class JwtUtil {
    ...
    private SecretKey getSigningKey() {
        ...
        try {
            ...
            // Accept secrets generated by both `openssl rand -base64` and
            // URL-safe generators. Production validation still requires at
            // least 256 bits of decoded key material.
